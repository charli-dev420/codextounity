...
Codex Unity ComfyUI Pipeline est un prototype local. Il sert a coordonner un pipeline d'assets 3D pour Unity sans transformer ComfyUI ou Unity en centre de decision.
